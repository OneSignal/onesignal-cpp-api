...
#include "CppRestOneSignalAPIClient/model/UpdateApiKeyRequest.h"
...
public:
    ...
    virtual pplx::task<std::shared_ptr<TemplateResource>> copyTemplateToApp(
        utility::string_t templateId,
        utility::string_t appId,
        std::shared_ptr<CopyTemplateRequest> copyTemplateRequest
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<CreateApiKeyResponse>> createApiKey(
        utility::string_t appId,
        std::shared_ptr<CreateApiKeyRequest> createApiKeyRequest
    ) const = 0;
    virtual pplx::task<std::shared_ptr<App>> createApp(
        std::shared_ptr<App> app
    ) const = 0;
    virtual pplx::task<std::shared_ptr<Object>> createCustomEvents(
        utility::string_t appId,
        std::shared_ptr<CustomEventsRequest> customEventsRequest
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<TemplateResource>> createTemplate(
        std::shared_ptr<CreateTemplateRequest> createTemplateRequest
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<Object>> deleteApiKey(
        utility::string_t appId,
    ...
    virtual pplx::task<std::shared_ptr<GenericSuccessBoolResponse>> deleteTemplate(
        utility::string_t templateId,
        utility::string_t appId
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<CreateApiKeyResponse>> rotateApiKey(
        utility::string_t appId,
        utility::string_t tokenId
    ) const = 0;
    virtual pplx::task<std::shared_ptr<StartLiveActivitySuccessResponse>> startLiveActivity(
        utility::string_t appId,
        utility::string_t activityType,
        std::shared_ptr<StartLiveActivityRequest> startLiveActivityRequest
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<Object>> updateApiKey(
        utility::string_t appId,
        utility::string_t tokenId,
        std::shared_ptr<UpdateApiKeyRequest> updateApiKeyRequest
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<Object>> updateSubscriptionByToken(
        utility::string_t appId,
        utility::string_t tokenType,
        utility::string_t token,
        std::shared_ptr<SubscriptionBody> subscriptionBody
    ) const = 0;
    virtual pplx::task<std::shared_ptr<TemplateResource>> updateTemplate(
        utility::string_t templateId,
        utility::string_t appId,
        std::shared_ptr<UpdateTemplateRequest> updateTemplateRequest
    ) const = 0;
    ...
    virtual pplx::task<std::shared_ptr<ApiKeyTokensListResponse>> viewApiKeys(
        utility::string_t appId
    ) const = 0;
    virtual pplx::task<std::shared_ptr<TemplateResource>> viewTemplate(
        utility::string_t templateId,
        utility::string_t appId
    ) const = 0;
    virtual pplx::task<std::shared_ptr<TemplatesListResponse>> viewTemplates(
        utility::string_t appId,
        boost::optional<int32_t> limit,
        boost::optional<int32_t> offset,
...
public:
    ...
    pplx::task<std::shared_ptr<TemplateResource>> copyTemplateToApp(
        utility::string_t templateId,
        utility::string_t appId,
        std::shared_ptr<CopyTemplateRequest> copyTemplateRequest
    ) const override;
    ...
    pplx::task<std::shared_ptr<CreateApiKeyResponse>> createApiKey(
        utility::string_t appId,
        std::shared_ptr<CreateApiKeyRequest> createApiKeyRequest
    ) const override;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<Object>> createCustomEvents(
        utility::string_t appId,
        std::shared_ptr<CustomEventsRequest> customEventsRequest
    ) const override;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<TemplateResource>> createTemplate(
        std::shared_ptr<CreateTemplateRequest> createTemplateRequest
    ) const override;
    /// <summary>
    /// 
    ...
    pplx::task<std::shared_ptr<Object>> deleteApiKey(
        utility::string_t appId,
        utility::string_t tokenId
    ) const override;
    /// <summary>
    ...
    /// <param name="templateId"></param>
    /// <param name="appId"></param>
    pplx::task<std::shared_ptr<GenericSuccessBoolResponse>> deleteTemplate(
        utility::string_t templateId,
        utility::string_t appId
    ) const override;
    /// <summary>
    ...
    /// <param name="appId"></param>
    /// <param name="tokenId"></param>
    pplx::task<std::shared_ptr<CreateApiKeyResponse>> rotateApiKey(
        utility::string_t appId,
        utility::string_t tokenId
    ) const override;
    /// <summary>
    ...
    pplx::task<std::shared_ptr<StartLiveActivitySuccessResponse>> startLiveActivity(
        utility::string_t appId,
        utility::string_t activityType,
        std::shared_ptr<StartLiveActivityRequest> startLiveActivityRequest
    ) const override;
    ...
    pplx::task<std::shared_ptr<Object>> updateApiKey(
        utility::string_t appId,
        utility::string_t tokenId,
        std::shared_ptr<UpdateApiKeyRequest> updateApiKeyRequest
    ) const override;
    ...
    /// <param name="subscriptionBody"></param>
    pplx::task<std::shared_ptr<Object>> updateSubscriptionByToken(
        utility::string_t appId,
        utility::string_t tokenType,
        utility::string_t token,
        std::shared_ptr<SubscriptionBody> subscriptionBody
    ...
    pplx::task<std::shared_ptr<TemplateResource>> updateTemplate(
        utility::string_t templateId,
        utility::string_t appId,
        std::shared_ptr<UpdateTemplateRequest> updateTemplateRequest
    ) const override;
    ...
    /// </remarks>
    /// <param name="appId"></param>
    pplx::task<std::shared_ptr<ApiKeyTokensListResponse>> viewApiKeys(
        utility::string_t appId
    ) const override;
    /// <summary>
    /// View template
    ...
    /// <param name="templateId"></param>
    /// <param name="appId"></param>
    pplx::task<std::shared_ptr<TemplateResource>> viewTemplate(
        utility::string_t templateId,
        utility::string_t appId
    ) const override;
    /// <summary>
    ...
    /// </remarks>
    /// <param name="appId">Your OneSignal App ID in UUID v4 format.</param>
    /// <param name="limit">Maximum number of templates. Default and max is 50. (optional, default to 0)</param>
    /// <param name="offset">Pagination offset. (optional, default to 0)</param>
    /// <param name="channel">Filter by delivery channel. (optional, default to utility::conversions::to_string_t(&quot;&quot;))</param>
    pplx::task<std::shared_ptr<TemplatesListResponse>> viewTemplates(
        utility::string_t appId,
        boost::optional<int32_t> limit,
        boost::optional<int32_t> offset,
        boost::optional<utility::string_t> channel
