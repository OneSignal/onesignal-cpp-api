...
public:
    ...
    /// 
    /// </summary>
    std::shared_ptr<LanguageStringMap> getSubtitle() const;
    bool subtitleIsSet() const;
    void unsetSubtitle();

    void setSubtitle(const std::shared_ptr<LanguageStringMap>& value);
    ...
    /// </summary>
    std::vector<std::shared_ptr<WebButton>>& getWebButtons();
    bool webButtonsIsSet() const;
    void unsetWeb_buttons();

    void setWebButtons(const std::vector<std::shared_ptr<WebButton>>& value);
    ...
    /// </summary>
    utility::string_t getIosInterruptionLevel() const;
    bool iosInterruptionLevelIsSet() const;
    void unsetIos_interruption_level();

    void setIosInterruptionLevel(const utility::string_t& value);
    ...
    /// </summary>
    bool isDisableEmailClickTracking() const;
    bool disableEmailClickTrackingIsSet() const;
    void unsetDisable_email_click_tracking();

    void setDisableEmailClickTracking(bool value);
...
protected:
    ...
    std::shared_ptr<LanguageStringMap> m_Subtitle;
    ...
    bool m_ButtonsIsSet;
    std::vector<std::shared_ptr<WebButton>> m_Web_buttons;
    ...
    utility::string_t m_Ios_interruption_level;
    bool m_Ios_interruption_levelIsSet;
    ...
    bool m_Disable_email_click_trackingIsSet;
