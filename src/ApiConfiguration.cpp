...
void ApiConfiguration::setOrganizationApiKeyToken( const utility::string_t& bearerToken )
{
    setBearerToken("organization_api_key", bearerToken);
}
void ApiConfiguration::setRestApiKeyToken( const utility::string_t& bearerToken )
{
    setBearerToken("rest_api_key", bearerToken);
}
