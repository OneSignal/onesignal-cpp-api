...
Export_subscriptions_request_body::Export_subscriptions_request_body()
{
...
void Export_subscriptions_request_body::validate()
{
    // TODO: implement validation
}

web::json::value Export_subscriptions_request_body::toJson() const
{
...
bool Export_subscriptions_request_body::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Export_subscriptions_request_body::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Export_subscriptions_request_body::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::vector<utility::string_t>& Export_subscriptions_request_body::getExtraFields()
{
    return m_Extra_fields;
}

void Export_subscriptions_request_body::setExtraFields(const std::vector<utility::string_t>& value)
{
    m_Extra_fields = value;
    m_Extra_fieldsIsSet = true;
}

bool Export_subscriptions_request_body::extraFieldsIsSet() const
{
    return m_Extra_fieldsIsSet;
}

void Export_subscriptions_request_body::unsetExtra_fields()
{
    m_Extra_fieldsIsSet = false;
}
utility::string_t Export_subscriptions_request_body::getLastActiveSince() const
{
    return m_Last_active_since;
}

void Export_subscriptions_request_body::setLastActiveSince(const utility::string_t& value)
{
    m_Last_active_since = value;
    m_Last_active_sinceIsSet = true;
}

bool Export_subscriptions_request_body::lastActiveSinceIsSet() const
{
    return m_Last_active_sinceIsSet;
}

void Export_subscriptions_request_body::unsetLast_active_since()
{
    m_Last_active_sinceIsSet = false;
}
utility::string_t Export_subscriptions_request_body::getSegmentName() const
{
    return m_Segment_name;
}

void Export_subscriptions_request_body::setSegmentName(const utility::string_t& value)
{
    m_Segment_name = value;
    m_Segment_nameIsSet = true;
}

bool Export_subscriptions_request_body::segmentNameIsSet() const
{
    return m_Segment_nameIsSet;
}

void Export_subscriptions_request_body::unsetSegment_name()
{
    m_Segment_nameIsSet = false;
}
}
