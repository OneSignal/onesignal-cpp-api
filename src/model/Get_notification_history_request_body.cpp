...
Get_notification_history_request_body::Get_notification_history_request_body()
{
...
void Get_notification_history_request_body::validate()
{
    // TODO: implement validation
}

web::json::value Get_notification_history_request_body::toJson() const
{
...
bool Get_notification_history_request_body::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void Get_notification_history_request_body::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool Get_notification_history_request_body::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t Get_notification_history_request_body::getEvents() const
{
    return m_Events;
}

void Get_notification_history_request_body::setEvents(const utility::string_t& value)
{
    m_Events = value;
    m_EventsIsSet = true;
}

bool Get_notification_history_request_body::eventsIsSet() const
{
    return m_EventsIsSet;
}

void Get_notification_history_request_body::unsetEvents()
{
    m_EventsIsSet = false;
}
utility::string_t Get_notification_history_request_body::getEmail() const
{
    return m_Email;
}

void Get_notification_history_request_body::setEmail(const utility::string_t& value)
{
    m_Email = value;
    m_EmailIsSet = true;
}

bool Get_notification_history_request_body::emailIsSet() const
{
    return m_EmailIsSet;
}

void Get_notification_history_request_body::unsetEmail()
{
    m_EmailIsSet = false;
}
utility::string_t Get_notification_history_request_body::getAppId() const
{
    return m_App_id;
}

void Get_notification_history_request_body::setAppId(const utility::string_t& value)
{
    m_App_id = value;
    m_App_idIsSet = true;
}

bool Get_notification_history_request_body::appIdIsSet() const
{
    return m_App_idIsSet;
}

void Get_notification_history_request_body::unsetApp_id()
{
    m_App_idIsSet = false;
}
}
