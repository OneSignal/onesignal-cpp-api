...
std::vector<utility::string_t>& BasicNotification::getIncludeSubscriptionIds()
{
    return m_Include_subscription_ids;
}

void BasicNotification::setIncludeSubscriptionIds(const std::vector<utility::string_t>& value)
{
    m_Include_subscription_ids = value;
    m_Include_subscription_idsIsSet = true;
}

bool BasicNotification::includeSubscriptionIdsIsSet() const
{
    return m_Include_subscription_idsIsSet;
}

void BasicNotification::unsetInclude_subscription_ids()
{
    m_Include_subscription_idsIsSet = false;
}
...
std::map<utility::string_t, utility::string_t>& BasicNotification::getIncludeAliases()
{
    return m_Include_aliases;
}

void BasicNotification::setIncludeAliases(const std::map<utility::string_t, utility::string_t>& value)
{
...
std::shared_ptr<LanguageStringMap> BasicNotification::getContents() const
{
    return m_Contents;
}

void BasicNotification::setContents(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Contents = value;
...
std::shared_ptr<LanguageStringMap> BasicNotification::getHeadings() const
{
    return m_Headings;
}

void BasicNotification::setHeadings(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Headings = value;
...
std::shared_ptr<LanguageStringMap> BasicNotification::getSubtitle() const
{
    return m_Subtitle;
}

void BasicNotification::setSubtitle(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Subtitle = value;
...
std::vector<std::shared_ptr<WebButton>>& BasicNotification::getWebButtons()
{
    return m_Web_buttons;
}

void BasicNotification::setWebButtons(const std::vector<std::shared_ptr<WebButton>>& value)
{
    m_Web_buttons = value;
...
double BasicNotification::getIosRelevanceScore() const
{
    return m_Ios_relevance_score;
}

void BasicNotification::setIosRelevanceScore(double value)
{
    m_Ios_relevance_score = value;
    m_Ios_relevance_scoreIsSet = true;
}

bool BasicNotification::iosRelevanceScoreIsSet() const
{
    return m_Ios_relevance_scoreIsSet;
}

void BasicNotification::unsetIos_relevance_score()
{
    m_Ios_relevance_scoreIsSet = false;
}
utility::string_t BasicNotification::getIosInterruptionLevel() const
{
    return m_Ios_interruption_level;
}

void BasicNotification::setIosInterruptionLevel(const utility::string_t& value)
{
    m_Ios_interruption_level = value;
    m_Ios_interruption_levelIsSet = true;
}

bool BasicNotification::iosInterruptionLevelIsSet() const
{
    return m_Ios_interruption_levelIsSet;
}

void BasicNotification::unsetIos_interruption_level()
{
    m_Ios_interruption_levelIsSet = false;
}
...
utility::string_t BasicNotification::getEmailReplyToAddress() const
{
    return m_Email_reply_to_address;
}

void BasicNotification::setEmailReplyToAddress(const utility::string_t& value)
{
    m_Email_reply_to_address = value;
    m_Email_reply_to_addressIsSet = true;
}

bool BasicNotification::emailReplyToAddressIsSet() const
{
    return m_Email_reply_to_addressIsSet;
}

void BasicNotification::unsetEmail_reply_to_address()
{
    m_Email_reply_to_addressIsSet = false;
}
...
bool BasicNotification::isDisableEmailClickTracking() const
{
    return m_Disable_email_click_tracking;
}

void BasicNotification::setDisableEmailClickTracking(bool value)
{
    m_Disable_email_click_tracking = value;
    m_Disable_email_click_trackingIsSet = true;
}

bool BasicNotification::disableEmailClickTrackingIsSet() const
{
    return m_Disable_email_click_trackingIsSet;
}

void BasicNotification::unsetDisable_email_click_tracking()
{
    m_Disable_email_click_trackingIsSet = false;
}
...
std::vector<std::shared_ptr<FilterExpression>>& BasicNotification::getFilters()
{
    return m_Filters;
}

void BasicNotification::setFilters(const std::vector<std::shared_ptr<FilterExpression>>& value)
{
    m_Filters = value;
    m_FiltersIsSet = true;
}
...
utility::string_t BasicNotification::getHuaweiBadgeClass() const
{
    return m_Huawei_badge_class;
}

void BasicNotification::setHuaweiBadgeClass(const utility::string_t& value)
{
    m_Huawei_badge_class = value;
    m_Huawei_badge_classIsSet = true;
}

bool BasicNotification::huaweiBadgeClassIsSet() const
{
    return m_Huawei_badge_classIsSet;
}

void BasicNotification::unsetHuawei_badge_class()
{
    m_Huawei_badge_classIsSet = false;
}
int32_t BasicNotification::getHuaweiBadgeAddNum() const
{
    return m_Huawei_badge_add_num;
}

void BasicNotification::setHuaweiBadgeAddNum(int32_t value)
{
    m_Huawei_badge_add_num = value;
    m_Huawei_badge_add_numIsSet = true;
}

bool BasicNotification::huaweiBadgeAddNumIsSet() const
{
    return m_Huawei_badge_add_numIsSet;
}

void BasicNotification::unsetHuawei_badge_add_num()
{
    m_Huawei_badge_add_numIsSet = false;
}
int32_t BasicNotification::getHuaweiBadgeSetNum() const
{
    return m_Huawei_badge_set_num;
}

void BasicNotification::setHuaweiBadgeSetNum(int32_t value)
{
    m_Huawei_badge_set_num = value;
    m_Huawei_badge_set_numIsSet = true;
}

bool BasicNotification::huaweiBadgeSetNumIsSet() const
{
    return m_Huawei_badge_set_numIsSet;
}

void BasicNotification::unsetHuawei_badge_set_num()
{
    m_Huawei_badge_set_numIsSet = false;
}
utility::string_t BasicNotification::getHuaweiCategory() const
{
    return m_Huawei_category;
}

void BasicNotification::setHuaweiCategory(const utility::string_t& value)
{
    m_Huawei_category = value;
    m_Huawei_categoryIsSet = true;
}

bool BasicNotification::huaweiCategoryIsSet() const
{
    return m_Huawei_categoryIsSet;
}

void BasicNotification::unsetHuawei_category()
{
    m_Huawei_categoryIsSet = false;
}
utility::string_t BasicNotification::getHuaweiBiTag() const
{
    return m_Huawei_bi_tag;
}

void BasicNotification::setHuaweiBiTag(const utility::string_t& value)
{
    m_Huawei_bi_tag = value;
    m_Huawei_bi_tagIsSet = true;
}

bool BasicNotification::huaweiBiTagIsSet() const
{
    return m_Huawei_bi_tagIsSet;
}

void BasicNotification::unsetHuawei_bi_tag()
{
    m_Huawei_bi_tagIsSet = false;
}
}
