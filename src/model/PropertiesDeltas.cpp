...
int32_t PropertiesDeltas::getSessionTime() const
{
    return m_Session_time;
}

void PropertiesDeltas::setSessionTime(int32_t value)
{
...
int32_t PropertiesDeltas::getSessionCount() const
{
    return m_Session_count;
}

void PropertiesDeltas::setSessionCount(int32_t value)
{
