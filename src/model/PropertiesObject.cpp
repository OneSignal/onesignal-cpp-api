...
int32_t PropertiesObject::getFirstActive() const
{
    return m_First_active;
}

void PropertiesObject::setFirstActive(int32_t value)
{
...
void PropertiesObject::setLastActive(int32_t value)
{
    m_Last_active = value;
