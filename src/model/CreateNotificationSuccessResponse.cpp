...
std::shared_ptr<AnyType> CreateNotificationSuccessResponse::getErrors() const
{
    return m_Errors;
}

void CreateNotificationSuccessResponse::setErrors(const std::shared_ptr<AnyType>& value)
{
    m_Errors = value;
    m_ErrorsIsSet = true;
}
