...
NotificationWithMeta::NotificationWithMeta()
{
    ...
    m_Ios_interruption_level = utility::conversions::to_string_t("");
    m_Ios_interruption_levelIsSet = false;
    ...
    m_Disable_email_click_trackingIsSet = false;
...
web::json::value NotificationWithMeta::toJson() const
{
    ...
    if(m_Ios_interruption_levelIsSet)
    {
        val[utility::conversions::to_string_t(U("ios_interruption_level"))] = ModelBase::toJson(m_Ios_interruption_level);
    }
    ...
    if(m_Disable_email_click_trackingIsSet)
    {
        val[utility::conversions::to_string_t(U("disable_email_click_tracking"))] = ModelBase::toJson(m_Disable_email_click_tracking);
    }
    ...
    if(m_CanceledIsSet)
    {
        val[utility::conversions::to_string_t(U("canceled"))] = ModelBase::toJson(m_Canceled);
    }
...
bool NotificationWithMeta::fromJson(const web::json::value& val)
{
    ...
    if(val.has_field(utility::conversions::to_string_t(U("subtitle"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::shared_ptr<LanguageStringMap> refVal_setSubtitle;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("web_buttons"))))
    {
        ...
        if(!fieldValue.is_null())
        {
            std::vector<std::shared_ptr<WebButton>> refVal_setWebButtons;
    ...
    if(val.has_field(utility::conversions::to_string_t(U("ios_interruption_level"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("ios_interruption_level")));
        if(!fieldValue.is_null())
        {
            utility::string_t refVal_setIosInterruptionLevel;
            ok &= ModelBase::fromJson(fieldValue, refVal_setIosInterruptionLevel);
            setIosInterruptionLevel(refVal_setIosInterruptionLevel);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("disable_email_click_tracking"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("disable_email_click_tracking")));
        if(!fieldValue.is_null())
        {
            bool refVal_setDisableEmailClickTracking;
            ok &= ModelBase::fromJson(fieldValue, refVal_setDisableEmailClickTracking);
            setDisableEmailClickTracking(refVal_setDisableEmailClickTracking);
        }
    }
    ...
    if(val.has_field(utility::conversions::to_string_t(U("canceled"))))
    {
        const web::json::value& fieldValue = val.at(utility::conversions::to_string_t(U("canceled")));
        if(!fieldValue.is_null())
        {
            bool refVal_setCanceled;
...
void NotificationWithMeta::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
    ...
    if(m_Ios_interruption_levelIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("ios_interruption_level")), m_Ios_interruption_level));
    }
    if(m_Email_subjectIsSet)
    {
    ...
    if(m_Disable_email_click_trackingIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("disable_email_click_tracking")), m_Disable_email_click_tracking));
    }
    if(m_Include_unsubscribedIsSet)
    {
    ...
    if(m_CanceledIsSet)
    {
        multipart->add(ModelBase::toHttpContent(namePrefix + utility::conversions::to_string_t(U("canceled")), m_Canceled));
    }
}
...
bool NotificationWithMeta::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("ios_interruption_level"))))
    {
        utility::string_t refVal_setIosInterruptionLevel;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("ios_interruption_level"))), refVal_setIosInterruptionLevel );
        setIosInterruptionLevel(refVal_setIosInterruptionLevel);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("disable_email_click_tracking"))))
    {
        bool refVal_setDisableEmailClickTracking;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("disable_email_click_tracking"))), refVal_setDisableEmailClickTracking );
        setDisableEmailClickTracking(refVal_setDisableEmailClickTracking);
    }
    ...
    if(multipart->hasContent(utility::conversions::to_string_t(U("canceled"))))
    {
        bool refVal_setCanceled;
        ok &= ModelBase::fromHttpContent(multipart->getContent(utility::conversions::to_string_t(U("canceled"))), refVal_setCanceled );
        setCanceled(refVal_setCanceled);
    }
    return ok;
}
...
std::vector<utility::string_t>& NotificationWithMeta::getIncludeSubscriptionIds()
{
    return m_Include_subscription_ids;
}

void NotificationWithMeta::setIncludeSubscriptionIds(const std::vector<utility::string_t>& value)
{
    m_Include_subscription_ids = value;
    m_Include_subscription_idsIsSet = true;
}

bool NotificationWithMeta::includeSubscriptionIdsIsSet() const
{
    return m_Include_subscription_idsIsSet;
}

void NotificationWithMeta::unsetInclude_subscription_ids()
{
    m_Include_subscription_idsIsSet = false;
}
...
std::map<utility::string_t, utility::string_t>& NotificationWithMeta::getIncludeAliases()
{
    return m_Include_aliases;
}

void NotificationWithMeta::setIncludeAliases(const std::map<utility::string_t, utility::string_t>& value)
{
...
std::shared_ptr<LanguageStringMap> NotificationWithMeta::getContents() const
{
    return m_Contents;
}

void NotificationWithMeta::setContents(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Contents = value;
...
std::shared_ptr<LanguageStringMap> NotificationWithMeta::getHeadings() const
{
    return m_Headings;
}

void NotificationWithMeta::setHeadings(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Headings = value;
...
std::shared_ptr<LanguageStringMap> NotificationWithMeta::getSubtitle() const
{
    return m_Subtitle;
}

void NotificationWithMeta::setSubtitle(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Subtitle = value;
...
std::vector<std::shared_ptr<WebButton>>& NotificationWithMeta::getWebButtons()
{
    return m_Web_buttons;
}

void NotificationWithMeta::setWebButtons(const std::vector<std::shared_ptr<WebButton>>& value)
{
    m_Web_buttons = value;
...
double NotificationWithMeta::getIosRelevanceScore() const
{
    return m_Ios_relevance_score;
}

void NotificationWithMeta::setIosRelevanceScore(double value)
{
    m_Ios_relevance_score = value;
    m_Ios_relevance_scoreIsSet = true;
}

bool NotificationWithMeta::iosRelevanceScoreIsSet() const
{
    return m_Ios_relevance_scoreIsSet;
}

void NotificationWithMeta::unsetIos_relevance_score()
{
    m_Ios_relevance_scoreIsSet = false;
}
utility::string_t NotificationWithMeta::getIosInterruptionLevel() const
{
    return m_Ios_interruption_level;
}

void NotificationWithMeta::setIosInterruptionLevel(const utility::string_t& value)
{
    m_Ios_interruption_level = value;
    m_Ios_interruption_levelIsSet = true;
}

bool NotificationWithMeta::iosInterruptionLevelIsSet() const
{
    return m_Ios_interruption_levelIsSet;
}

void NotificationWithMeta::unsetIos_interruption_level()
{
    m_Ios_interruption_levelIsSet = false;
}
...
utility::string_t NotificationWithMeta::getEmailReplyToAddress() const
{
    return m_Email_reply_to_address;
}

void NotificationWithMeta::setEmailReplyToAddress(const utility::string_t& value)
{
    m_Email_reply_to_address = value;
    m_Email_reply_to_addressIsSet = true;
}

bool NotificationWithMeta::emailReplyToAddressIsSet() const
{
    return m_Email_reply_to_addressIsSet;
}

void NotificationWithMeta::unsetEmail_reply_to_address()
{
    m_Email_reply_to_addressIsSet = false;
}
...
bool NotificationWithMeta::isDisableEmailClickTracking() const
{
    return m_Disable_email_click_tracking;
}

void NotificationWithMeta::setDisableEmailClickTracking(bool value)
{
    m_Disable_email_click_tracking = value;
    m_Disable_email_click_trackingIsSet = true;
}

bool NotificationWithMeta::disableEmailClickTrackingIsSet() const
{
    return m_Disable_email_click_trackingIsSet;
}

void NotificationWithMeta::unsetDisable_email_click_tracking()
{
    m_Disable_email_click_trackingIsSet = false;
}
...
std::vector<std::shared_ptr<FilterExpression>>& NotificationWithMeta::getFilters()
{
    return m_Filters;
}

void NotificationWithMeta::setFilters(const std::vector<std::shared_ptr<FilterExpression>>& value)
{
    m_Filters = value;
    m_FiltersIsSet = true;
}
...
utility::string_t NotificationWithMeta::getHuaweiBadgeClass() const
{
    return m_Huawei_badge_class;
}

void NotificationWithMeta::setHuaweiBadgeClass(const utility::string_t& value)
{
    m_Huawei_badge_class = value;
    m_Huawei_badge_classIsSet = true;
}

bool NotificationWithMeta::huaweiBadgeClassIsSet() const
{
    return m_Huawei_badge_classIsSet;
}

void NotificationWithMeta::unsetHuawei_badge_class()
{
    m_Huawei_badge_classIsSet = false;
}
int32_t NotificationWithMeta::getHuaweiBadgeAddNum() const
{
    return m_Huawei_badge_add_num;
}

void NotificationWithMeta::setHuaweiBadgeAddNum(int32_t value)
{
    m_Huawei_badge_add_num = value;
    m_Huawei_badge_add_numIsSet = true;
}

bool NotificationWithMeta::huaweiBadgeAddNumIsSet() const
{
    return m_Huawei_badge_add_numIsSet;
}

void NotificationWithMeta::unsetHuawei_badge_add_num()
{
    m_Huawei_badge_add_numIsSet = false;
}
int32_t NotificationWithMeta::getHuaweiBadgeSetNum() const
{
    return m_Huawei_badge_set_num;
}

void NotificationWithMeta::setHuaweiBadgeSetNum(int32_t value)
{
    m_Huawei_badge_set_num = value;
    m_Huawei_badge_set_numIsSet = true;
}

bool NotificationWithMeta::huaweiBadgeSetNumIsSet() const
{
    return m_Huawei_badge_set_numIsSet;
}

void NotificationWithMeta::unsetHuawei_badge_set_num()
{
    m_Huawei_badge_set_numIsSet = false;
}
utility::string_t NotificationWithMeta::getHuaweiCategory() const
{
    return m_Huawei_category;
}

void NotificationWithMeta::setHuaweiCategory(const utility::string_t& value)
{
    m_Huawei_category = value;
    m_Huawei_categoryIsSet = true;
}

bool NotificationWithMeta::huaweiCategoryIsSet() const
{
    return m_Huawei_categoryIsSet;
}

void NotificationWithMeta::unsetHuawei_category()
{
    m_Huawei_categoryIsSet = false;
}
utility::string_t NotificationWithMeta::getHuaweiBiTag() const
{
    return m_Huawei_bi_tag;
}

void NotificationWithMeta::setHuaweiBiTag(const utility::string_t& value)
{
    m_Huawei_bi_tag = value;
    m_Huawei_bi_tagIsSet = true;
}

bool NotificationWithMeta::huaweiBiTagIsSet() const
{
    return m_Huawei_bi_tagIsSet;
}

void NotificationWithMeta::unsetHuawei_bi_tag()
{
    m_Huawei_bi_tagIsSet = false;
}
...
bool NotificationWithMeta::isCanceled() const
{
    return m_Canceled;
}

void NotificationWithMeta::setCanceled(bool value)
{
    m_Canceled = value;
    m_CanceledIsSet = true;
}

bool NotificationWithMeta::canceledIsSet() const
{
    return m_CanceledIsSet;
}

void NotificationWithMeta::unsetCanceled()
{
    m_CanceledIsSet = false;
}
}
