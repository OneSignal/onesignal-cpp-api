...
void UpdateApiKeyRequest::validate()
{
    // TODO: implement validation
}

web::json::value UpdateApiKeyRequest::toJson() const
{
...
bool UpdateApiKeyRequest::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void UpdateApiKeyRequest::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool UpdateApiKeyRequest::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
utility::string_t UpdateApiKeyRequest::getName() const
{
    return m_Name;
}

void UpdateApiKeyRequest::setName(const utility::string_t& value)
{
    m_Name = value;
    m_NameIsSet = true;
}

bool UpdateApiKeyRequest::nameIsSet() const
{
    return m_NameIsSet;
}

void UpdateApiKeyRequest::unsetName()
{
    m_NameIsSet = false;
}
utility::string_t UpdateApiKeyRequest::getIpAllowlistMode() const
{
    return m_Ip_allowlist_mode;
}

void UpdateApiKeyRequest::setIpAllowlistMode(const utility::string_t& value)
{
    m_Ip_allowlist_mode = value;
    m_Ip_allowlist_modeIsSet = true;
}

bool UpdateApiKeyRequest::ipAllowlistModeIsSet() const
{
    return m_Ip_allowlist_modeIsSet;
}

void UpdateApiKeyRequest::unsetIp_allowlist_mode()
{
    m_Ip_allowlist_modeIsSet = false;
}
std::vector<utility::string_t>& UpdateApiKeyRequest::getIpAllowlist()
{
    return m_Ip_allowlist;
}

void UpdateApiKeyRequest::setIpAllowlist(const std::vector<utility::string_t>& value)
{
    m_Ip_allowlist = value;
    m_Ip_allowlistIsSet = true;
}

bool UpdateApiKeyRequest::ipAllowlistIsSet() const
{
    return m_Ip_allowlistIsSet;
}

void UpdateApiKeyRequest::unsetIp_allowlist()
{
    m_Ip_allowlistIsSet = false;
}
}
