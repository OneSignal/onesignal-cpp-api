...
void PropertiesBody::validate()
{
    // TODO: implement validation
}

web::json::value PropertiesBody::toJson() const
{
...
bool PropertiesBody::fromJson(const web::json::value& val)
{
    bool ok = true;
...
void PropertiesBody::toMultipart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix) const
{
...
bool PropertiesBody::fromMultiPart(std::shared_ptr<MultipartFormData> multipart, const utility::string_t& prefix)
{
    bool ok = true;
    utility::string_t namePrefix = prefix;
    if(namePrefix.size() > 0 && namePrefix.substr(namePrefix.size() - 1) != utility::conversions::to_string_t(U(".")))
...
std::shared_ptr<PropertiesObject> PropertiesBody::getProperties() const
{
    return m_Properties;
}

void PropertiesBody::setProperties(const std::shared_ptr<PropertiesObject>& value)
{
    m_Properties = value;
    m_PropertiesIsSet = true;
}

bool PropertiesBody::propertiesIsSet() const
{
    return m_PropertiesIsSet;
}

void PropertiesBody::unsetProperties()
{
    m_PropertiesIsSet = false;
}
}
