...
std::vector<utility::string_t>& NotificationTarget::getIncludeSubscriptionIds()
{
    return m_Include_subscription_ids;
}

void NotificationTarget::setIncludeSubscriptionIds(const std::vector<utility::string_t>& value)
{
    m_Include_subscription_ids = value;
    m_Include_subscription_idsIsSet = true;
}

bool NotificationTarget::includeSubscriptionIdsIsSet() const
{
    return m_Include_subscription_idsIsSet;
}

void NotificationTarget::unsetInclude_subscription_ids()
{
    m_Include_subscription_idsIsSet = false;
}
...
std::map<utility::string_t, utility::string_t>& NotificationTarget::getIncludeAliases()
{
    return m_Include_aliases;
}

void NotificationTarget::setIncludeAliases(const std::map<utility::string_t, utility::string_t>& value)
{
