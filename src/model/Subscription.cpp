...
utility::string_t Subscription::getType() const
{
    return m_Type;
}

void Subscription::setType(const utility::string_t& value)
{
    m_Type = value;
    m_TypeIsSet = true;
}

bool Subscription::typeIsSet() const
{
    return m_TypeIsSet;
}

void Subscription::unsetType()
{
    m_TypeIsSet = false;
}
utility::string_t Subscription::getToken() const
{
    return m_Token;
}

void Subscription::setToken(const utility::string_t& value)
{
    m_Token = value;
    m_TokenIsSet = true;
}

bool Subscription::tokenIsSet() const
{
    return m_TokenIsSet;
}

void Subscription::unsetToken()
{
    m_TokenIsSet = false;
}
...
void Subscription::unsetEnabled()
{
    m_EnabledIsSet = false;
}
int32_t Subscription::getNotificationTypes() const
{
    return m_Notification_types;
}

void Subscription::setNotificationTypes(int32_t value)
{
    m_Notification_types = value;
    m_Notification_typesIsSet = true;
}

bool Subscription::notificationTypesIsSet() const
{
    return m_Notification_typesIsSet;
}

void Subscription::unsetNotification_types()
{
    m_Notification_typesIsSet = false;
}
int32_t Subscription::getSessionTime() const
{
    return m_Session_time;
}

void Subscription::setSessionTime(int32_t value)
{
    m_Session_time = value;
    m_Session_timeIsSet = true;
}

bool Subscription::sessionTimeIsSet() const
{
    return m_Session_timeIsSet;
}

void Subscription::unsetSession_time()
{
    m_Session_timeIsSet = false;
}
int32_t Subscription::getSessionCount() const
{
    return m_Session_count;
}

void Subscription::setSessionCount(int32_t value)
{
    m_Session_count = value;
    m_Session_countIsSet = true;
}

bool Subscription::sessionCountIsSet() const
{
    return m_Session_countIsSet;
}

void Subscription::unsetSession_count()
{
    m_Session_countIsSet = false;
}
utility::string_t Subscription::getSdk() const
{
    return m_Sdk;
}

void Subscription::setSdk(const utility::string_t& value)
{
    m_Sdk = value;
    m_SdkIsSet = true;
}

bool Subscription::sdkIsSet() const
{
    return m_SdkIsSet;
}

void Subscription::unsetSdk()
{
    m_SdkIsSet = false;
}
utility::string_t Subscription::getDeviceModel() const
{
    return m_Device_model;
}

void Subscription::setDeviceModel(const utility::string_t& value)
{
    m_Device_model = value;
    m_Device_modelIsSet = true;
}

bool Subscription::deviceModelIsSet() const
{
    return m_Device_modelIsSet;
}

void Subscription::unsetDevice_model()
{
    m_Device_modelIsSet = false;
}
utility::string_t Subscription::getDeviceOs() const
{
    return m_Device_os;
}

void Subscription::setDeviceOs(const utility::string_t& value)
{
    m_Device_os = value;
    m_Device_osIsSet = true;
}

bool Subscription::deviceOsIsSet() const
{
    return m_Device_osIsSet;
}

void Subscription::unsetDevice_os()
{
    m_Device_osIsSet = false;
}
bool Subscription::isRooted() const
{
    return m_Rooted;
}

void Subscription::setRooted(bool value)
{
    m_Rooted = value;
    m_RootedIsSet = true;
}

bool Subscription::rootedIsSet() const
{
    return m_RootedIsSet;
}

void Subscription::unsetRooted()
{
    m_RootedIsSet = false;
}
int32_t Subscription::getTestType() const
{
    return m_Test_type;
}

void Subscription::setTestType(int32_t value)
{
    m_Test_type = value;
    m_Test_typeIsSet = true;
}

bool Subscription::testTypeIsSet() const
{
    return m_Test_typeIsSet;
}

void Subscription::unsetTest_type()
{
    m_Test_typeIsSet = false;
}
utility::string_t Subscription::getAppVersion() const
{
    return m_App_version;
}

void Subscription::setAppVersion(const utility::string_t& value)
{
    m_App_version = value;
    m_App_versionIsSet = true;
}

bool Subscription::appVersionIsSet() const
{
    return m_App_versionIsSet;
}

void Subscription::unsetApp_version()
{
    m_App_versionIsSet = false;
}
int32_t Subscription::getNetType() const
{
    return m_Net_type;
}

void Subscription::setNetType(int32_t value)
{
    m_Net_type = value;
    m_Net_typeIsSet = true;
}

bool Subscription::netTypeIsSet() const
{
    return m_Net_typeIsSet;
}

void Subscription::unsetNet_type()
{
    m_Net_typeIsSet = false;
}
utility::string_t Subscription::getCarrier() const
{
    return m_Carrier;
}

void Subscription::setCarrier(const utility::string_t& value)
{
    m_Carrier = value;
    m_CarrierIsSet = true;
}

bool Subscription::carrierIsSet() const
{
    return m_CarrierIsSet;
}

void Subscription::unsetCarrier()
{
    m_CarrierIsSet = false;
}
utility::string_t Subscription::getWebAuth() const
{
    return m_Web_auth;
}

void Subscription::setWebAuth(const utility::string_t& value)
{
    m_Web_auth = value;
    m_Web_authIsSet = true;
}

bool Subscription::webAuthIsSet() const
{
    return m_Web_authIsSet;
}

void Subscription::unsetWeb_auth()
{
    m_Web_authIsSet = false;
}
utility::string_t Subscription::getWebP256() const
{
    return m_Web_p256;
}

void Subscription::setWebP256(const utility::string_t& value)
{
    m_Web_p256 = value;
    m_Web_p256IsSet = true;
}

bool Subscription::webP256IsSet() const
{
    return m_Web_p256IsSet;
}

void Subscription::unsetWeb_p256()
{
    m_Web_p256IsSet = false;
}
}
