...
std::vector<utility::string_t>& Notification::getIncludeSubscriptionIds()
{
    return m_Include_subscription_ids;
}

void Notification::setIncludeSubscriptionIds(const std::vector<utility::string_t>& value)
{
    m_Include_subscription_ids = value;
    m_Include_subscription_idsIsSet = true;
}

bool Notification::includeSubscriptionIdsIsSet() const
{
    return m_Include_subscription_idsIsSet;
}

void Notification::unsetInclude_subscription_ids()
{
    m_Include_subscription_idsIsSet = false;
}
...
std::map<utility::string_t, utility::string_t>& Notification::getIncludeAliases()
{
    return m_Include_aliases;
}

void Notification::setIncludeAliases(const std::map<utility::string_t, utility::string_t>& value)
{
...
std::shared_ptr<LanguageStringMap> Notification::getContents() const
{
    return m_Contents;
}

void Notification::setContents(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Contents = value;
...
std::shared_ptr<LanguageStringMap> Notification::getHeadings() const
{
    return m_Headings;
}

void Notification::setHeadings(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Headings = value;
...
std::shared_ptr<LanguageStringMap> Notification::getSubtitle() const
{
    return m_Subtitle;
}

void Notification::setSubtitle(const std::shared_ptr<LanguageStringMap>& value)
{
    m_Subtitle = value;
...
std::vector<std::shared_ptr<WebButton>>& Notification::getWebButtons()
{
    return m_Web_buttons;
}

void Notification::setWebButtons(const std::vector<std::shared_ptr<WebButton>>& value)
{
    m_Web_buttons = value;
...
double Notification::getIosRelevanceScore() const
{
    return m_Ios_relevance_score;
}

void Notification::setIosRelevanceScore(double value)
{
    m_Ios_relevance_score = value;
    m_Ios_relevance_scoreIsSet = true;
}

bool Notification::iosRelevanceScoreIsSet() const
{
    return m_Ios_relevance_scoreIsSet;
}

void Notification::unsetIos_relevance_score()
{
    m_Ios_relevance_scoreIsSet = false;
}
utility::string_t Notification::getIosInterruptionLevel() const
{
    return m_Ios_interruption_level;
}

void Notification::setIosInterruptionLevel(const utility::string_t& value)
{
    m_Ios_interruption_level = value;
    m_Ios_interruption_levelIsSet = true;
}

bool Notification::iosInterruptionLevelIsSet() const
{
    return m_Ios_interruption_levelIsSet;
}

void Notification::unsetIos_interruption_level()
{
    m_Ios_interruption_levelIsSet = false;
}
...
utility::string_t Notification::getEmailReplyToAddress() const
{
    return m_Email_reply_to_address;
}

void Notification::setEmailReplyToAddress(const utility::string_t& value)
{
    m_Email_reply_to_address = value;
    m_Email_reply_to_addressIsSet = true;
}

bool Notification::emailReplyToAddressIsSet() const
{
    return m_Email_reply_to_addressIsSet;
}

void Notification::unsetEmail_reply_to_address()
{
    m_Email_reply_to_addressIsSet = false;
}
...
bool Notification::isDisableEmailClickTracking() const
{
    return m_Disable_email_click_tracking;
}

void Notification::setDisableEmailClickTracking(bool value)
{
    m_Disable_email_click_tracking = value;
    m_Disable_email_click_trackingIsSet = true;
}

bool Notification::disableEmailClickTrackingIsSet() const
{
    return m_Disable_email_click_trackingIsSet;
}

void Notification::unsetDisable_email_click_tracking()
{
    m_Disable_email_click_trackingIsSet = false;
}
...
std::vector<std::shared_ptr<FilterExpression>>& Notification::getFilters()
{
    return m_Filters;
}

void Notification::setFilters(const std::vector<std::shared_ptr<FilterExpression>>& value)
{
    m_Filters = value;
    m_FiltersIsSet = true;
}
...
utility::string_t Notification::getHuaweiBadgeClass() const
{
    return m_Huawei_badge_class;
}

void Notification::setHuaweiBadgeClass(const utility::string_t& value)
{
    m_Huawei_badge_class = value;
    m_Huawei_badge_classIsSet = true;
}

bool Notification::huaweiBadgeClassIsSet() const
{
    return m_Huawei_badge_classIsSet;
}

void Notification::unsetHuawei_badge_class()
{
    m_Huawei_badge_classIsSet = false;
}
int32_t Notification::getHuaweiBadgeAddNum() const
{
    return m_Huawei_badge_add_num;
}

void Notification::setHuaweiBadgeAddNum(int32_t value)
{
    m_Huawei_badge_add_num = value;
    m_Huawei_badge_add_numIsSet = true;
}

bool Notification::huaweiBadgeAddNumIsSet() const
{
    return m_Huawei_badge_add_numIsSet;
}

void Notification::unsetHuawei_badge_add_num()
{
    m_Huawei_badge_add_numIsSet = false;
}
int32_t Notification::getHuaweiBadgeSetNum() const
{
    return m_Huawei_badge_set_num;
}

void Notification::setHuaweiBadgeSetNum(int32_t value)
{
    m_Huawei_badge_set_num = value;
    m_Huawei_badge_set_numIsSet = true;
}

bool Notification::huaweiBadgeSetNumIsSet() const
{
    return m_Huawei_badge_set_numIsSet;
}

void Notification::unsetHuawei_badge_set_num()
{
    m_Huawei_badge_set_numIsSet = false;
}
utility::string_t Notification::getHuaweiCategory() const
{
    return m_Huawei_category;
}

void Notification::setHuaweiCategory(const utility::string_t& value)
{
    m_Huawei_category = value;
    m_Huawei_categoryIsSet = true;
}

bool Notification::huaweiCategoryIsSet() const
{
    return m_Huawei_categoryIsSet;
}

void Notification::unsetHuawei_category()
{
    m_Huawei_categoryIsSet = false;
}
utility::string_t Notification::getHuaweiBiTag() const
{
    return m_Huawei_bi_tag;
}

void Notification::setHuaweiBiTag(const utility::string_t& value)
{
    m_Huawei_bi_tag = value;
    m_Huawei_bi_tagIsSet = true;
}

bool Notification::huaweiBiTagIsSet() const
{
    return m_Huawei_bi_tagIsSet;
}

void Notification::unsetHuawei_bi_tag()
{
    m_Huawei_bi_tagIsSet = false;
}
