...
bool NotificationWithMeta_allOf::isCanceled() const
{
    return m_Canceled;
}

void NotificationWithMeta_allOf::setCanceled(bool value)
{
    m_Canceled = value;
    m_CanceledIsSet = true;
}

bool NotificationWithMeta_allOf::canceledIsSet() const
{
    return m_CanceledIsSet;
}

void NotificationWithMeta_allOf::unsetCanceled()
{
    m_CanceledIsSet = false;
}
}
